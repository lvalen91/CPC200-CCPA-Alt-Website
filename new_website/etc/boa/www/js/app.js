...
const App = {
    ...
    CONFIG_META: {
        ...
        MicGainSwitch:              {d:0,  min:0,max:1,     s:'A',c:'audio',   n:'Microphone gain boost', v:{0:'Normal gain',1:'Boosted gain'}},
        ...
        HudGPSSwitch:               {d:1,  min:0,max:1,     s:'A',c:'gps',     n:'GPS forwarding (CarPlay only)', v:{0:'Off',1:'On — forward HU GPS via iAP2'}},
        CarDate:                    {d:0,  min:0,max:65535, s:'A',c:'system',  n:'Vehicle date for session metadata', v:{0:'Not set'}},
        WiFiChannel:                {d:36, min:1,max:165,   s:'A',c:'network', n:'WiFi channel (triggers WiFi+BT restart)'},
        ...
        CustomCarLogo:              {d:0,  min:0,max:1,     s:'A',c:'display', n:'Boot logo source', v:{0:'Default manufacturer logo',1:'Custom uploaded PNG'}},
        VideoBitRate:               {d:0,  min:0,max:20,    s:'A',c:'video',   n:'H.264 bitrate level', v:{0:'Auto (adaptive)'}},
        ...
        CarDrivePosition:           {d:0,  min:0,max:1,     s:'A',c:'display', n:'Driving position (affects UI layout)', v:{0:'Left-hand drive',1:'Right-hand drive'}},
        ...
        NaviAudio:                  {d:0,  min:0,max:2,     s:'A',c:'audio',   n:'Navigation audio routing', v:{0:'Off',1:'Mix with media',2:'Duck media'}},
        ...
        BtAudio:                    {d:0,  min:0,max:1,     s:'A',c:'audio',   n:'Audio routing', v:{0:'Adapter (USB)',1:'Phone Bluetooth'}},
        ...
        VrVolumGain:                {d:0,  min:0,max:1,     s:'A',c:'audio',   n:'Voice recognition volume boost', v:{0:'Normal',1:'Boosted'}},
        ...
        LogoType:                   {d:0,  min:0,max:3,     s:'A',c:'display', n:'Boot logo selection', v:{0:'Default',1:'airplay_1.conf',2:'airplay_2.conf',3:'airplay_3.conf'}},
        BackRecording:              {d:0,  min:0,max:1,     s:'A',c:'system',  n:'Background recording', v:{0:'Disabled',1:'Enabled'}},
        ...
        NaviVolume:                 {d:0,  min:0,max:100,   s:'A',c:'audio',   n:'Navigation voice volume (0-100)'},
        ...
        UseUartBLE:                 {d:0,  min:0,max:1,     s:'A',c:'network', n:'UART BLE transport', v:{0:'USB BLE',1:'UART BLE'}},
